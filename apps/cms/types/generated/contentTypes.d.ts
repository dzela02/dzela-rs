...
export interface ApiExperienceEntryExperienceEntry extends Struct.CollectionTypeSchema {
  collectionName: 'experience_entries';
  info: {
    displayName: 'Experience Entry';
    pluralName: 'experience-entries';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::experience-entry.experience-entry': ApiExperienceEntryExperienceEntry;
